...
project = 'networkqit'
copyright = '2017-{}, networkqit Developers'.format(date.today().year)
...
modindex_common_prefix = ['networkqit.']

doctest_global_setup = "import networkqit as nq"
...
html_use_opensearch = 'http://carlonicolini.github.io/networkqit'

# Output file base name for HTML help builder.
htmlhelp_basename = 'networkqit'
...
latex_documents = [('reference/index', 'networkqit_reference.tex',
                    'networkqit Reference',
                    'Carlo Nicolini', 'manual', 1)]
